...
@Component({
  selector: 'mixcore-host-for-test',
  template: ''
})
class HostComponent {
  actionHandler = () => {};
...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<mixcore-big-input-action></mixcore-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<mixcore-big-input-action [disabled]="true"></mixcore-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<mixcore-big-input-action fontSet="fas" fontIcon="fa-trash"></mixcore-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<mixcore-big-input-action label="delete"></mixcore-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<mixcore-big-input-action (action)="actionHandler()"></mixcore-big-input-action>`;
    fixture = createHostComponent(template);
